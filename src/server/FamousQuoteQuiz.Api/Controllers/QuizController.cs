...
namespace FamousQuoteQuiz.Api.Controllers
{
    ...
    public class QuizController : ApiController
    {
		...
		/// <summary>
		/// Gets last <see cref="BinaryChoiceQuestion"/>.
		/// </summary>
		...
		/// <summary>
		/// Gets <see cref="BinaryChoiceQuestion"/> whose ID is bigger the one received.
		/// </summary>
		/// <param name="initialId">
		/// ID of <see cref="BinaryChoiceQuestion"/> which has to be surpassed.
		/// </param>
		...
		/// </summary>
		/// <param name="initialId">
		/// ID of <see cref="MultipleChoiceQuestion"/> which has to be surpassed.
		/// </param>
